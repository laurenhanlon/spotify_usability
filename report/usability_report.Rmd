...
In an effort to better understand the design of Spotify and it's functionality, I conducted a series of usability tests.
...
When promted to add songs to the playlist that she had never heard before, the second user (moderate) instantly went to the `Browse/Top lists` portion of the platform in order to discover new songs. She browded the `Top lists` of her area and selected two new rap songs.

The third user (new) had trouble finding new songs. After jumping around a few pages, she found new songs under the `Top hits` playlist. This is not an ideal place to find songs if she were looking for one song in particular. She said that her first instinct was not to go to the `Search` bar.
